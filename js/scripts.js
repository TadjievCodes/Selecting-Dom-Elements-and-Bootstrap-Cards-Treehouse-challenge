...
const cards = document.getElemenetsByClassName("card");
...
const container = document.getElementByClassName("container")[1];
...
const letters = document.querySelectorAll("a[title]");
letters.style.color = "#dc2456";
